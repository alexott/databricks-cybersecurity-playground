...
def drop_duplicates_with_merge(
    ...
    :param additional_merge_cond: additional merge condition appended to the generated condition using AND
    :return: nothing
    """
    ...
    if not df._jdf.isEmpty():
        ...
        except Exception as ex:  # this happens when table doesn't exist
